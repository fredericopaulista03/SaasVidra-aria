                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="type" name="type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="glass" {{ old('type') == 'glass' ? 'selected' : '' }}>Vidro (m²)</option>
                                    <option value="hardware" {{ old('type') == 'hardware' ? 'selected' : '' }}>Ferragem (un)</option>
                                    <option value="accessory" {{ old('type') == 'accessory' ? 'selected' : '' }}>Acessório (un)</option>
                                    <option value="service" {{ old('type') == 'service' ? 'selected' : '' }}>Serviço (un)</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="unit" class="block mt-1 w-full" type="text" name="unit" :value="old('unit', 'm2')" required placeholder="Ex: m2, un, kg" />
                            ...
                            <div>
                                ...
                                <x-text-input id="thickness" class="block mt-1 w-full" type="number" step="0.1" name="thickness" :value="old('thickness')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="color" class="block mt-1 w-full" type="text" name="color" :value="old('color')" placeholder="Ex: Incolor, Fumê, Cromado" />
